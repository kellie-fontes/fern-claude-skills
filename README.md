...
1. Run `/01-fern-design` with your industry, persona, and flow descriptions — Claude writes a populated `fern-context.md` to your project directory
2. Open `fern-context.md` and fill in the credential fields (`client_id`, `client_secret`, `business_group_id`, `org_alias`, `org_domain`)
3. Run each `/NN-fern-*` skill in order — Claude reads `fern-context.md` automatically, no manual value replacement needed
